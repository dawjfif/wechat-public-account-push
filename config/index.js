export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  // APP_ID: "wxb4a7bf37ad85f6b1",

  // 公众号APP_SECRET 
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  // APP_SECRET: "a8f80cc3baf408bcb455b840e764793b",
   ...
   *    id: "of_jp6V46XPwNvKm21q2QqUGnWnA",
   *    // 你想对他发送的模板消息的模板ID
   *    useTemplateId: "YmD1hdWaqzwFa_senltBcD60XRpB8mczCSuz6k1D2z0",
